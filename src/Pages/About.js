...
import BobImage from "../media/bob.png";
...
function AboutPage(params) {
  return (
    <Container>
      ...
      <p>
        <span className="bob">Bob</span> je više od modnog brenda. Mi smo priča
        o izražavanju individualnosti kroz modu. Ovdje u{" "}
        <span className="bob">Bobu</span>, svaki komad garderobe nosi sa sobom
      ...
      <p>
        ...
        <span className="bob">Bob</span> je tu da obogati vaš svakodnevni stil.
      </p>
      <p>
      ...
      <p>
        Dobrodošli u <span className="bob">Bob</span> - mesto gde se moda
